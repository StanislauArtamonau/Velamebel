...
if ! wp core is-installed; then
    wp core install --url='localhost' --title='Velamebel' --admin_user='admin' --admin_password='admin' --admin_email='admin@example.com'
fi
...
echo "php_value memory_limit 2G" >> /var/www/html/.htaccess